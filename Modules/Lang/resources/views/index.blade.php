                            ...
                            <table id="alternativePagination" class="display dataTable w-full text-sm align-middle whitespace-nowrap" style="width:100%" aria-describedby="alternativePagination_info">
                                ...
                                <tbody>
                                    ...
                                    <tr class="group-[.stripe]:even:bg-slate-50 group-[.stripe]:dark:even:bg-zink-600 transition-all duration-150 ease-linear group-[.hover]:hover:bg-slate-50 dark:group-[.hover]:hover:bg-zink-600 [&amp;.selected]:bg-custom-500 dark:[&amp;.selected]:bg-custom-500 [&amp;.selected]:text-custom-50 dark:[&amp;.selected]:text-custom-50">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{route('lang.edit', $lang->id)}}" class="btn btn-phoenix-success me-1 mb-1" type="button">
                                                ...
                                                @else
                                                <a href="{{route('lang.changeDefault',$lang->id)}}" class="btn btn-phoenix-info me-1 mb-1 set_default_lang" class="btn btn-phoenix-info me-1 mb-1" type="button">
                                                ...
                                                @endif
                                                @if($lang->status)
                                                @if($activeLangsCount < 2 or $langs->count() < 2) <a style="cursor: none" class="btn btn-phoenix-danger me-1 mb-1" type="link">
                                                        ...
                                                        @else
                                                        <a href="{{route('lang.changeStatusFalse',$lang->id)}}" class="btn btn-phoenix-secondary me-1 mb-1 change_status_false" type="link">
                                                        ...
                                                        @else
                                                        <a href="{{route('lang.changeStatusTrue',$lang->id)}}" class="btn btn-phoenix-secondary me-1 mb-1 change_status_true" type="button">
