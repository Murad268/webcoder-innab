                    ...
                    <div>
                        <form enctype="multipart/form-data" method="post" action="{{route('partners.update', $partner->id)}}">
                            ...
                            <div class="mb-3">
                                ...
                                @if($partner->images->count()<1) <input multiple name="image[]" type="file" class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500">
                                @endif
                            </div>
