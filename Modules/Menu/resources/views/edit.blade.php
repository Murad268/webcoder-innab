                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" method="post" action="{{route('menu.store')}}">
                            ...
                            <div class="mt-5 tab-content ">
                                ...
                                <div class="block tab-pane {{ $isFirst ? 'block' : 'hidden'}}" id="{{$language->code}}">
                                    <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
                                        <div class="mb-3">
                                            <label for="inputText1" class="inline-block mb-2 text-base font-medium">Link adı ({{$language->code}})<span class="text-red-500">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label for="inputText1" class="inline-block mb-2 text-base font-medium">Link seo başlığı ({{$language->code}})<span class="text-red-500">*</span></label>
                                            <input type="text" id="inputText1" name="seo_title[{{$language->code}}]" value="{{old('seo_title'.$language->code, $model->getTranslation('title', $language->code))}}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
                                        ...
                                        <div class="mb-3">
                                            <label for="inputText1" class="inline-block mb-2 text-base font-medium">Seo açar sözləri ({{$language->code}})<span class="text-red-500">*</span></label>
                                            <textarea name="seo_keywords[{{ $language->code }}]" class="ckeditortext form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" id="textArea" rows="3">{{ old('seo_keywords.' . $language->code, $model->getTranslation('title', $language->code)) }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="inputText1" class="inline-block mb-2 text-base font-medium">Seo açıqlama ({{$language->code}})<span class="text-red-500">*</span></label>
                                            <textarea name="seo_description[{{ $language->code }}]" class="ckeditortext form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" id="textArea" rows="3">{{ old('seo_description.' . $language->code, $model->getTranslation('title', $language->code)) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
                            ...
                            <div class="mb-3">
                                <label for="inputText1" class="inline-block mb-2 text-base font-medium">Aid olduğu menyu<span class="text-red-500">*</span></label>
